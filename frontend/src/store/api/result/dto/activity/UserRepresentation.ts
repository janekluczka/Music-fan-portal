...
export function toUserDetails(userRepresentation: UserRepresentation): UserDetails {
    return {
        ...
        payment: {
            method: userRepresentation.attributes.paymentMethod.length > 0 ? userRepresentation.attributes.paymentMethod[0] : "Not provided",
            currency: userRepresentation.attributes.currency.length > 0 ? userRepresentation.attributes.currency[0] : "Not provided",
        },
        personal: {
